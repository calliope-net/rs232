...
*/ {
    ...
    //% block="Pins: LED %pinLED Fototransistor %pinFototransistor Helligkeit < %helligkeit" weight=5
    //% pinLED.defl=DigitalPin.P1 pinFototransistor.defl=AnalogPin.P2 helligkeit.defl=150
